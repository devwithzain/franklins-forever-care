    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <h2 class="heading">2FA Login Verification</h2>
                <p class="description">A login attempt was made to your account. Use the code below to verify your identity and complete sign in.</p>
                ...
                <div class="warning-box">
                    <p class="warning-text">⚠️ <strong>Notice:</strong> If you did not initiate this login request, please secure your account by changing your password immediately.</p>
                </div>
            </div>
            <div class="footer">
