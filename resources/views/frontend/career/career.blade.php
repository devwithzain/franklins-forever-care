               ...
               <div class="grid grid-cols-2 gap-4 sm:grid-cols-1">
                  ...
                  <div class="space-y-1.5">
                     ...
                     <input type="email" name="email" value="{{ old('email', $user->email) }}" required readonly
                        ...
                        class="w-full h-14 rounded-xl border-0 bg-gray-100 px-5 outline-none cursor-not-allowed">
               ...
               <div class="grid grid-cols-2 gap-4 sm:grid-cols-1">
                  <div class="space-y-1.5">
                     <label class="text-xs font-bold uppercase tracking-wider text-gray-500 ml-1">Phone
                        Number</label>
                     <input type="text" name="phone" value="{{ old('phone') }}" required placeholder="+1 (555) 000-0000"
                        class="w-full h-14 rounded-xl border-0 bg-white px-5 outline-none focus:ring-2 focus:ring-[#7E80B0] transition-all">
                  ...
                  <div class="space-y-1.5">
                     <label class="text-xs font-bold uppercase tracking-wider text-gray-500 ml-1">Zip
                        Code</label>
                     <input type="text" name="zip_code" value="{{ old('zip_code') }}" required placeholder="12345"
                        class="w-full h-14 rounded-xl border-0 bg-white px-5 outline-none focus:ring-2 focus:ring-[#7E80B0] transition-all">
