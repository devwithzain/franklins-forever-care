        ...
        <div class="w-full max-w-[440px]">
            <div
                ...
                <div class="mb-7">
                    ...
                    <div class="text-[22px] font-bold text-theme-text-main">Register</div>
                    <div class="text-[13px] text-theme-text-muted mt-1">Create a new account on Franklin's Home Care</div>
                </div>
                @if ($errors->any())
                    <div
                    ...
                    <div
                        class="bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-[9px] p-3 text-sm text-green-700 dark:text-green-400 mb-4">
                        {{ session('status') }}
                </div> @endif <form method="POST" action="{{ route('register.store') }}">
                    @csrf
                    <div class="mb-4">
                        <label class="block text-[13px] font-semibold text-theme-text-main mb-1.5" for="name">Full
                            Name</label>
                        <div class="relative">
                            <span
                                class="absolute left-3 top-1/2 -translate-y-1/2 text-theme-text-muted pointer-events-none">
                                <svg class="w-[15px] h-[15px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-at"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M8 12a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M16 12v1.5a2.5 2.5 0 0 0 5 0v-1.5a9 9 0 1 0 -5.5 8.28" /></svg>
                            </span>
                            <input
                                ...
                                type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Your name"
        ...
        <input
            ...
            autocomplete="new-password" />
                ...
                <div class="flex justify-center items-center mt-5 gap-2">
                        <p class="flex items-center gap-1.5 text-[13px] text-theme-text-muted cursor-pointer">
                            Already have an account?
                        </p>
                        <a href="{{ route('login') }}"
                            class="text-[13px] text-theme-primary font-semibold no-underline hover:underline">Login</a>
                </div>
            </div>
        </div>
    </div>
