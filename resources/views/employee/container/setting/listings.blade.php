...
<div class="w-full flex items-center justify-between gap-5">
   <div>
      ...
      <div class="text-[13px] text-theme-text-muted mt-1">Manage your profile information, security, and active
         sessions.
      </div>
   </div>
</div>
               ...
               <label class="flex items-center justify-between cursor-pointer group">
                  ...
                  <div class="relative inline-flex items-center">
                     <input type="checkbox" name="two_factor_enabled" value="1"
                        {{ Auth::user()->two_factor_enabled ? 'checked' : '' }} class="sr-only peer">
                     <div
         ...
         <div class="p-6 space-y-6">
            ...
            <div class="flex items-center justify-between">
               <div class="flex items-center gap-4">
                  <div
                     class="w-10 h-10 rounded-full bg-theme-bg flex items-center justify-center text-theme-text-muted">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
               <div>
                  ...
                  <input name="password" type="password"
                     class="w-full bg-theme-bg border border-theme-border rounded-lg px-4 py-2.5 text-[13px] outline-none focus:border-[#1a3cdc]"
                     placeholder="••••••••">
                  @error('password') <span class="text-red-500 text-[11px] font-bold mt-1 block">{{ $message }}</span>
                  @enderror
               </div>
               <div>
